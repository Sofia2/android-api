...
import com.indra.sofia2.ssapandroid.ssap.body.config.message.SSAPBodyConfigAppsw;
import com.indra.sofia2.ssapandroid.ssap.body.config.message.SSAPBodyConfigAsset;
import com.indra.sofia2.ssapandroid.ssap.body.config.message.SSAPBodyConfigOntologia;
...
public class SSAPBodyConfigMessage extends SSAPBodyMessage {
	...
	public static SSAPBodyConfigMessage fromJsonToSSAPBodyConfigMessage(String json) {
		try {
			return JSON.deserialize(json, SSAPBodyConfigMessage.class);
		} catch (IOException e) {
