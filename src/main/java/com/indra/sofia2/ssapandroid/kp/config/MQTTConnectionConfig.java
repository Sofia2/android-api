...
package com.indra.sofia2.ssapandroid.kp.config;
...
public class MQTTConnectionConfig extends ConnectionConfig {
	...
	/**
	 * Sets the quality of service to use for the Will message. Defaults to QoS.AT_LEAST_ONCE.
	 */
	private QoS qualityOfService=QoS.AT_LEAST_ONCE;
